import memojiImage from "@/assets/images/memoji (3).png";
      ...
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          <h1 className="font-serif text-3xl md:text-5xl text-center mt-8 tracking-wider">
            {" "}
            Crafting Intuitive Digital Experience
          </h1>
          <p className="mt-4 text-center text-white/60 md:text-lg">
            {" "}
            Transforming ideas into powerful web apps with MERN and more. Let's
